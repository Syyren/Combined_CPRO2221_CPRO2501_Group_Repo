...
import TictactoeMenu from "./components/tictactoe/tictactoeMenu"; // Later, put this into unified layout rather than direct route
    ...
    <div>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/game/tictactoe" element={<TictactoeMenu />} />
